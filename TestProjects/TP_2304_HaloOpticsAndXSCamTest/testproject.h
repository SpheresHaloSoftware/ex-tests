...
using namespace cv;
class testproject : public dockingportGSP, public opticsmountGSP {
...
public:
	...
	void GSsetup();
	void GSrunMain();
	void GSstreamImages(cv::Mat& leftImg, cv::Mat& rightImg,cv::Mat& singleImg); // image processing science algorithms
