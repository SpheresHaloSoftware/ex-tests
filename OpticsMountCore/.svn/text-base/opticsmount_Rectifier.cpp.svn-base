...
int opticsmount_Rectifier::calcRectificationMaps(int imgwidth, int imgheight, const char calibParamDir[200])
{
...
int opticsmount_Rectifier::rectifyImages(cv::Mat& leftImgFrame, cv::Mat& rightImgFrame)
{
...
void opticsmount_Rectifier::getCameraParameters(cv::Mat& Qin, cv::Mat& Rin, cv::Mat& Tin, cv::Mat& R1in, cv::Mat& P1in,
...
void opticsmount_Rectifier::getCameraParameters(cv::Mat& Qin)
{
    Qin = this->Q;
}


void opticsmount_Rectifier::getCameraParameters(cv::Mat& Rin, cv::Mat& Tin, cv::Mat& M1in, cv::Mat& D1in, cv::Mat& M2in, cv::Mat& D2in) {
    Rin = this->R;
    Tin = this->T;
    M1in = this->M1;
    D1in = this->D1;
...
void opticsmount_Rectifier::getCameraParameters(double & cx_left,double &  cy_left,double &  cx_right,double &  cy_right,double &  f_left,double &  f_right,double &  Tx,double &  Ty,double &  Tz) {
