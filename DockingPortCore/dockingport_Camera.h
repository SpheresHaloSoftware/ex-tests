...
class dockingport_Camera
{
	...
	DP_UEYE_IMAGE Cam2_ringbuffer[RING_BUFFER_SIZE];
...
public:
	...
	bool useOneCamera; // for single camera test projects

	dockingport_Camera() // with default settings
	{
		iterDummy = 0;
		// Flags
		useSynchCams = true;
		...
		useOneCamera = false; // Most operations are not with one camera
